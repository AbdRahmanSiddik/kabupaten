          ...
          <div class="right_side">
            <div class="fcrse_2 mb-30">
                ...
                @if (Auth::check())
                  @if (auth()->user()->foto_profile == null)
                    <a href="/profile/{{ auth()->user()->token_users }} "> <img
                        src="{{ asset('') }}assets/images/no-profile.jpg " width="50" height="35"
                        alt=""></a>
                  @else
                    <a href="/profile/{{ auth()->user()->token_users }} "><img
                        src="{{ asset('foto_profile/' . auth()->user()->foto_profile) }}" alt=""></a>
                  @endif
                @else
                  <a href=""><img src="{{ asset('assets/images/no-profile.jpg') }}" alt=""></a>
                @endif
              ...
              <div class="tutor_content_dt">
                ...
                @else
                  <div type="button" class="prfle12link" data-bs-toggle="modal" data-bs-target="#modalLogin">
                    Login
                  </div>
                @endif
