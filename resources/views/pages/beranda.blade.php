                ...
                <div class="col-xl-6 col-lg-12 col-md-6">
                  <div class="value_props">
                    ...
                    <div class="value_content">
                      ...
                      <p>Nikmati pengalaman berbelanja dengan pilihan produk berkualitas dari UMKM terbaik kami, dengan
                ...
                <div class="col-xl-6 col-lg-12 col-md-6">
                  <div class="value_props">
                    ...
                    <div class="value_content">
                      ...
                      <p>Temukan produk unik dari UMKM lokal dari daerah Sumenep yang menawarkan kualitas dan keunikan
                ...
                <div class="col-xl-6 col-lg-12 col-md-6">
                  <div class="value_props">
                    ...
                    <div class="value_content">
                      ...
                      <p>Dukung UMKM lokal dengan membeli produk-produk yang dibuat dengan penuh cinta dan dedikasi oleh
                ...
                <div class="col-xl-6 col-lg-12 col-md-6">
                  <div class="value_props">
                    ...
                    <div class="value_content">
                      ...
                      <p>Kolaborasi untuk mendorong pertumbuhan ekonomi lokal dengan inovasi dan kreativitas.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="right_side">
              ...
              <div class="fcrse_3">
                ...
                <ul class="allcate15">
                  ...
                  <li><a href="#" class="ct_item"><i class='uil uil-shopping-basket'></i>Minuman</a></li>
              ...
              <div class="la5lo1">
                <div class="owl-carousel Student_says owl-theme">
                  <div class="item">
                    <div class="fcrse_4 mb-20">
                      <div class="say_content">
                        <p>"Donec ac ex eu arcu euismod feugiat. In venenatis bibendum nisi, in placerat eros ultricies
                  ...
                  <div class="item">
                    <div class="fcrse_4 mb-20">
                      <div class="say_content">
                        <p>"Cras id enim lectus. Fusce at arcu tincidunt, iaculis libero quis, vulputate mauris. Morbi
                  ...
                  <div class="item">
                    <div class="fcrse_4 mb-20">
                      <div class="say_content">
                        <p>"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Class aptent taciti sociosqu ad
                          litora torquent per conubia nostra, per inceptos himenaeos eros ac, sagittis orci."</p>
                      </div>
                      <div class="st_group">
                        <div class="stud_img">
                          <img src="{{ asset('assets') }}/images/left-imgs/img-7.jpg" alt="">
                  ...
                  <div class="item">
                    <div class="fcrse_4 mb-20">
                      <div class="say_content">
                        <p>"Nulla bibendum lectus pharetra, tempus eros ac, sagittis orci. Suspendisse posuere dolor
                          neque, at finibus mauris lobortis in. Pellentesque vitae laoreet tortor."</p>
                      </div>
                      <div class="st_group">
                        <div class="stud_img">
                          <img src="{{ asset('assets') }}/images/left-imgs/img-6.jpg" alt="">
                  ...
                  <div class="item">
                    <div class="fcrse_4 mb-20">
                      <div class="say_content">
                        <p>"Curabitur placerat justo ac mauris condimentum ultricies. In magna tellus, eleifend et
