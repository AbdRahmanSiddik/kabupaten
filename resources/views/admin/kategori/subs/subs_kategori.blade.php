...
<div class="sa4d25">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12">
          <h2 class="st_title"><i class="uil uil-book-alt"></i>Kategori {{ $kategori->nama_kategori }}</h2>
        </div>
        <div class="col-md-12">
          ...
          <div class="tab-pane fade show active" id="pills-my-courses">
            <div class="table-responsive mt-30">
              <table class="table ucp-table">
                ...
                <tbody>
                  @foreach ($semua_sub as $get)
                    <tr>
                      <td class="text-start ms-2" style="width: 25%;">{{ $get->created_at->format('yms') }}</td>
                      <td style="width: 30%">{{ $get->nama_sub_kategori }}</td>
                      <td class="text-center">
                        <button type="button" title="Edit" data-bs-toggle="modal"
                          data-bs-target="#exampleModal{{ $get->id_sub_kategori }}" class="btn gray-s"><i
                            class="uil uil-edit-alt"></i></button>
                        <button type="button" title="Delete" data-bs-toggle="modal"
                        data-bs-target="#staticBackdrop{{ $get->id_sub_kategori }}" class="btn gray-s"><i class="uil uil-trash-alt"></i></button>
                      </td>
                      </td>
                    </tr>

                    <!-- Modal -->
                    <div class="modal fade" id="staticBackdrop{{ $get->id_sub_kategori }}" data-bs-backdrop="static" data-bs-keyboard="false"
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body text-center">
                            Yakin ingin menghapus kategori {{ $get->nama_sub_kategori }}<br>
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="exampleModal{{ $get->id_sub_kategori }}" tabindex="-1"
                          ...
                          <form action="/admin/kategori/{{ $get->kategori_id }}/{{ $get->id_sub_kategori }}/subs" method="POST">
                            ...
                            <div class="modal-body">
                              <div class="ui search focus lbel25">
                                ...
                                <div class="ui left icon input swdh19">
                                  <input class="prompt srch_explore" type="text" placeholder="Course title here"
                                    value="{{ $get->nama_sub_kategori }}" name="nama_kategori"
