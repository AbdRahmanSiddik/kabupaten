                ...
                <div class="row">
                  <div class="col-6">
                    <div class="ui search focus mt-30 lbel25">
                      ...
                      <div class="ui left icon input swdh19">
                        <input class="prompt srch_explore" type="text" placeholder="Course title here" name="title"
                  ...
                  <div class="col-6">
                    <div class="ui search focus mt-30 lbel25">
                      ...
                      <select class="selectpicker" title="Select Category" name="selectcategory" id="selectcategory"
                    ...
                    <div class="ui search focus mt-30 lbel25">
                      ...
                      <div id="input-container">
                        <div class="ui left icon input swdh19 mt-2 mb-2">
                          <input class="prompt srch_explore" type="text" placeholder="Varian: Original, Pedas" name="input[]"
                  ...
                  <div class="col-6">
                    <div class="ui search focus mt-30 lbel25">
                      ...
                      <div id="input-containers">
                        <div class="ui left icon input swdh19 mt-2 mb-2">
                          <input class="prompt srch_explore" type="text" placeholder="Ukuran: XL, 100g, 1kg" name="inputs[]"
                            data-purpose="edit-course-title" id="main[title]" value="">
                        </div>
                      </div>
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-6 mb-2">
                        ...
                        <div class="thumb-item">
                            <!-- Gambar default -->
                            <img id="thumbnail-preview" src="{{ asset('') }}assets/images/thumbnail-demo.jpg" alt="Thumbnail Produk" style="width: 100%; height: auto;">
                            <div class="thumb-dt">
