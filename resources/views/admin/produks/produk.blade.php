        ...
        <div class="col-md-12">
          <div class="my_courses_tabs">
            <ul class="nav nav-pills my_crse_nav" id="pills-tab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="pills-my-courses-tab" data-bs-toggle="pill" href="#pills-my-courses"
                  role="tab" aria-controls="pills-my-courses" aria-selected="true"><i
                    class="uil uil-book-alt"></i>Produk Saya</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="pills-my-purchases-tab" data-bs-toggle="pill" href="#pills-my-purchases"
                  role="tab" aria-controls="pills-my-purchases" aria-selected="false"><i
                    class="uil uil-download-alt"></i>Histori Penjualan</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="pills-upcoming-courses-tab" data-bs-toggle="pill" href="#pills-upcoming-courses"
                  role="tab" aria-controls="pills-upcoming-courses" aria-selected="false"><i
                    class="uil uil-upload-alt"></i>Produk Mendatang</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" id="pills-promotions-tab" data-bs-toggle="pill" href="#pills-promotions"
                  role="tab" aria-controls="pills-promotions" aria-selected="false"><i class="uil uil-megaphone">
                  </i>Promosi</a>
              </li>
            </ul>
                      ...
                      @foreach ($dataProduk as $get)
                        <tr>
                          ...
                          <td class="text-center">
                            ...
                            data-bs-target="#editModal{{ $get->id_produks }}" title="Edit" class="gray-s"><i
                        ...
                        <div class="modal fade" id="editModal{{ $get->id_produks }}" data-bs-backdrop="static"
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body d-flex justify-content-around">
                                  <a href="{{ route('foto-produk.index') }}?id={{ $get->id_produks }}" class="create_btn_dash rounded pt-2">Edit Foto Produk</a>
                                  <a href="{{ route('produk.edit', $get->id_produks) }}" class="create_btn_dash rounded pt-2">Edit Produk</a>
                              </div>
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="headingOne">
                      <div class="panel-title adcrse1250">
                        <a class="collapsed" data-bs-toggle="collapse" data-bs-parent="#accordion" href="#collapseOne"
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                  <div class="ui search focus mt-20 lbel25">
                                    ...
                                    <div class="ui left icon input swdh19">
                                      <input class="prompt srch_explore" type="number" name="off" value=""
                                ...
                                <div class="col-lg-6 col-md-6">
                                  <div class="ui search focus mt-20 lbel25">
                                    ...
                                    <div class="ui left icon input swdh19">
                                      <input class="prompt srch_explore datepicker-here" type="text"
