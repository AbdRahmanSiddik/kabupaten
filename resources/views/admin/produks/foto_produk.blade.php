      ...
      <div class="row mt-0">
        <div class="col-12">
          <div class="course_tabs_1">
            <div class="step-app">
              <form action="{{ route('foto-produk.update', $_GET['id']) }}" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                @method("PUT")
                  ...
                  <div class="step-tab-panel step-tab-info active">
                    <div class="tab-from-content">
                      <div class="title-icon">
                        <h3 class="title"><i class="uil uil-info-circle"></i>Foto Produk {{ $detail->nama_produk }}</h3>
                      </div>
                      <div class="course__form">
                        <div class="general_info10">
                          <div class="row">
                                ...
                                <div class="thumb-item">
                                  ...
                                  <div class="thumb-dt">
                                    <div class="upload-btn">
                                      <!-- Input file -->
                                      <input class="uploadBtn-main-input" type="file" id="ThumbFile__input--source{{ $item->id_atribut_produk }}"
                                        name="thumbnail[]" accept="image/*">
                                      <label for="ThumbFile__input--source{{ $item->id_atribut_produk }}" title="Zip">Tambahkan Foto</label>
                                    </div>
                            ...
                            <script>
                                document.getElementById('ThumbFile__input--source{{ $item->id_atribut_produk }}').addEventListener('change', function(event) {
                                  ...
                                  if (file && file.type.startsWith('image/')) {
                                    ...
                                    reader.onload = function(e) {
                                      document.getElementById('thumbnail-preview{{ $item->id_atribut_produk }}').src = e.target.result;
                                    };
